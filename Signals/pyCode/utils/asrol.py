...
# this currently inherits a flaw from fill_date_gaps
#   fill_date_gaps may be "overenthusiastic" about filling gaps
#   it fills gaps no matter how long they are. This is not a problem
#   with standard panels. But if you have a weird panel, for example
#   if you only use stocks with low BM (as in MS.py, Mohanram 2005)
#   then you can have super long gaps.
# RDAbility.py seems to have this issue, so we have a specialized asrol
#   for that predictor. Ultimately, we may want to have
