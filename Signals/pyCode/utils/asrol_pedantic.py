...
# this version of asrol is matches asrol.ado exactly but is much slower
...
def asrol_pedantic(df: pd.DataFrame, *, options: AsrolOptions) -> pd.DataFrame:
    """
...
def asrol_pedantic_wrapper(df, group_col, time_col, value_col, window, stat='mean', new_col_name=None, min_periods=1, consecutive_only=True):
    """
