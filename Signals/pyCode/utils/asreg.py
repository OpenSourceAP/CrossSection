#!/usr/bin/env python3
# ABOUTME: Stata-style asreg regression functions for cross-sectional and rolling window analysis
# ABOUTME: Fast polars and pandas implementations with collinearity handling and statistical output
