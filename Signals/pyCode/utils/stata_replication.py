...
# ABOUTME: Includes stata_quantile, asreg_collinear (pandas), and asreg_polars (fast polars version)

import numpy as np
import pandas as pd
from collections import deque
from typing import List, Dict, Tuple, Optional, Sequence, Iterable, Literal
import fnmatch
import warnings
...
# =============================================================================
# Polars-based asreg implementation (fast, no collinearity handling)
# =============================================================================
"""
asreg_polars: Fast polars-based implementation for OLS regressions.
- Uses polars and polars-ols for performance
- Does NOT handle collinearity (assumes full rank)
- Supports rolling, expanding, and group modes
- Best for large datasets where collinearity is not a concern

asreg_collinear: Pandas-based implementation with collinearity handling (above).
- Exact Stata replication with proper collinearity detection
- Slower but more robust for rank-deficient cases
- Use when exact Stata compatibility is required
"""
