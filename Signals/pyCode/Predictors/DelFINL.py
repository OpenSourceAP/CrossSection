...
lag_data.columns = ['permno', 'time_lag12', 'l12_at', 'l12_dltt', 'l12_dlc', 'l12_tempPSTK']
...
df['DelFINL'] = ((df['dltt'] + df['dlc'] + df['tempPSTK']) - 
                 (df['l12_dltt'] + df['l12_dlc'] + df['l12_tempPSTK'])) / df['tempAvAT']
