...
df = asrol_fast(df, 'permno', 'time_avail_m', 'divamt', 24, "monthly", stat='sum', new_col_name='divsum')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'temp', 6, "monthly", stat='sum', new_col_name='initsum')
