...
for var in variables:
    # Create quintile rankings for each characteristic by month
    df_pandas[f'cat_{var}'] = fastxtile(df_pandas, var, by='time_avail_m', n=5)
    
    # Set RIO interaction to cat_RIO when characteristic is in top quintile
...
# Special case for Dispersion: use top 2 quintiles instead of just top quintile
df = df.with_columns(
