...
# original paper uses Dec 31 obs for ib and mve_permco, while our 
# mve_permco gets updated monthly.  Thus, we lag mve_permco 6 months
...
df = pd.merge(signal_master, compustat[['permno', 'time_avail_m', 'ib']], 
