...
df.loc[(df['chearn'] > 0) & (df['l3_chearn'] <= 0), 'nincr'] = 1

# replace nincr = 2 if chearn > 0 & l3.chearn >0 & l6.chearn <=0  
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & (df['l6_chearn'] <= 0), 'nincr'] = 2

# replace nincr = 3 if chearn > 0 & l3.chearn >0 & l6.chearn >0 & l9.chearn <=0
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & (df['l9_chearn'] <= 0), 'nincr'] = 3

# replace nincr = 4 if chearn > 0 & l3.chearn >0 & l6.chearn >0 & l9.chearn >0 & l12.chearn <=0
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & ((df['l9_chearn'] > 0) | df['l9_chearn'].isna()) & (df['l12_chearn'] <= 0), 'nincr'] = 4

# replace nincr = 5 if chearn > 0 & l3.chearn >0 & l6.chearn >0 & l9.chearn >0 & l12.chearn >0 & l15.chearn <=0
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & ((df['l9_chearn'] > 0) | df['l9_chearn'].isna()) & ((df['l12_chearn'] > 0) | df['l12_chearn'].isna()) & (df['l15_chearn'] <= 0), 'nincr'] = 5

# replace nincr = 6 if chearn > 0 & l3.chearn >0 & l6.chearn >0 & l9.chearn >0 & l12.chearn >0 & l15.chearn >0 & l18.chearn <=0
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & ((df['l9_chearn'] > 0) | df['l9_chearn'].isna()) & ((df['l12_chearn'] > 0) | df['l12_chearn'].isna()) & ((df['l15_chearn'] > 0) | df['l15_chearn'].isna()) & (df['l18_chearn'] <= 0), 'nincr'] = 6

# replace nincr = 7 if chearn > 0 & l3.chearn >0 & l6.chearn >0 & l9.chearn >0 & l12.chearn >0 & l15.chearn >0 & l18.chearn >0 & l21.chearn <=0
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & ((df['l9_chearn'] > 0) | df['l9_chearn'].isna()) & ((df['l12_chearn'] > 0) | df['l12_chearn'].isna()) & ((df['l15_chearn'] > 0) | df['l15_chearn'].isna()) & ((df['l18_chearn'] > 0) | df['l18_chearn'].isna()) & (df['l21_chearn'] <= 0), 'nincr'] = 7
...
df.loc[(df['chearn'] > 0) & ((df['l3_chearn'] > 0) | df['l3_chearn'].isna()) & ((df['l6_chearn'] > 0) | df['l6_chearn'].isna()) & ((df['l9_chearn'] > 0) | df['l9_chearn'].isna()) & ((df['l12_chearn'] > 0) | df['l12_chearn'].isna()) & ((df['l15_chearn'] > 0) | df['l15_chearn'].isna()) & ((df['l18_chearn'] > 0) | df['l18_chearn'].isna()) & ((df['l21_chearn'] > 0) | df['l21_chearn'].isna()) & (df['l24_chearn'] <= 0), 'nincr'] = 8
