...
# Create upgrade indicator based on month-over-month changes
...
# Identify recommendation upgrades (lower values = better recommendations)
...
# Note: Preserve observations with missing lag values (assigned UpRecomm=0)
