...
df = df[['gvkey', 'permno', 'time_avail_m', 'ni', 'prstkcc', 'sstk', 'dvt', 'oancf', 'fincf', 'ivncf']].copy()
...
df['PctTotAcc'] = (df['ni'] - (df['prstkcc'] - df['sstk'] + df['dvt'] + df['oancf'] + df['fincf'] + df['ivncf'])) / np.abs(df['ni'])
