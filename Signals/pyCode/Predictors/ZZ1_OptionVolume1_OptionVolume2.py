...
optvold = pd.read_csv('../pyData/Prep/OptionMetricsVolume.csv',
                      usecols=['secid', 'date', 'optvolume_js12']).rename(columns={'optvolume_js12': 'optvolume_js12'})
...
optvolm = optvold.groupby(['secid', 'time_avail_m'])['optvolume_js12'].sum().reset_index()
