...
# ABOUTME: R&D intensity as R&D expenditure (xrd) divided by market value of equity (mve_permco)
...
Inputs:
    - ../pyData/Intermediate/SignalMasterTable.parquet (permno, time_avail_m, mve_permco, gvkey)
