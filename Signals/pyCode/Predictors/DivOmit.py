...
df = asrol_fast(df, 'permno', 'time_avail_m', 'divind', 3, "monthly", stat='sum', new_col_name='sum3_divind')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'temppaid', 18, "monthly", stat='mean', new_col_name='mean18_temppaid')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'divind', 6, "monthly", stat='sum', new_col_name='sum6_divind')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'divind', 12, "monthly", stat='sum', new_col_name='sum12_divind')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'temppaid', 24, "monthly", stat='mean', new_col_name='mean24_temppaid')
...
df = asrol_fast(df, 'permno', 'time_avail_m', 'omitnow', 2, "monthly", stat='sum', new_col_name='temp')
