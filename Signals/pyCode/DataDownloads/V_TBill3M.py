...
def main():
    ...
    print("3-month T-bill rate data saved with {len(final_data)} quarterly records")
    print("Date range: {final_data['year'].min()}Q{final_data[final_data['year'] == final_data['year'].min()]['qtr'].min()} to {final_data['year'].max()}Q{final_data[final_data['year'] == final_data['year'].max()]['qtr'].max()}")
    ...
    print("\nT-bill rate summary:")
    print("Mean: {final_data['TbillRate3M'].mean():.4f}")
    print("Std: {final_data['TbillRate3M'].std():.4f}")
    print("Min: {final_data['TbillRate3M'].min():.4f}")
    print("Max: {final_data['TbillRate3M'].max():.4f}")
