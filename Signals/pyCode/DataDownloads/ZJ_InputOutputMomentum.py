# ABOUTME: Python wrapper for Input-Output Momentum R script processing
# ABOUTME: Basically just a wrapper and some post-processing
...
"""Main function that downloads BEA data, calls R script, and handles post-processing"""
