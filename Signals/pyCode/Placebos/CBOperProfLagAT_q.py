...
print("Applying enhanced group-wise forward-only fill for Compustat data...")
...
qcomp = qcomp.with_columns([
    ...
    pl.col('rectq').fill_null(strategy="forward").over('gvkey').alias('rectq'),
    pl.col('invtq').fill_null(strategy="forward").over('gvkey').alias('invtq'),
    pl.col('drcq').fill_null(strategy="forward").over('gvkey').alias('drcq'),
    pl.col('drltq').fill_null(strategy="forward").over('gvkey').alias('drltq'),
    pl.col('apq').fill_null(strategy="forward").over('gvkey').alias('apq'),
    pl.col('xaccq').fill_null(strategy="forward").over('gvkey').alias('xaccq')
])
