...
print("Computing pchcurrat with 12-month calendar-based lag...")
...
lag_data = df_pandas[['permno', 'time_avail_m', 'currat']].copy()
lag_data.columns = ['permno', 'time_lag12', 'l12_currat']
