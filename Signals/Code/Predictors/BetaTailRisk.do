...
* CHECKPOINT 1
list permno time_d ret time_avail_m if permno == 78050 & time_avail_m >= tm(1998m11) & time_avail_m <= tm(1999m2), sep(0)
...
preserve
	...
	* CHECKPOINT 2
	list time_avail_m retp5 if time_avail_m >= tm(1998m11) & time_avail_m <= tm(1999m2), sep(0)
...
list permno time_d ret retp5 time_avail_m if permno == 78050 & time_avail_m >= tm(1998m11) & time_avail_m <= tm(1999m2), sep(0)

gen tailex = log(ret/retp5)

* CHECKPOINT 4
list permno time_d ret retp5 tailex time_avail_m if permno == 78050 & time_avail_m >= tm(1998m11) & time_avail_m <= tm(1999m2), sep(0)

gcollapse (mean) tailex, by(time_avail_m) 

* CHECKPOINT 5
list time_avail_m tailex if time_avail_m >= tm(1998m11) & time_avail_m <= tm(1999m2), sep(0)
...
* CHECKPOINT 6
list permno time_avail_m ret tailex shrcd if permno == 78050 & time_avail_m >= tm(1990m1) & time_avail_m <= tm(2000m12), sep(0)
...
* CHECKPOINT 7
list permno time_avail_m BetaTailRisk if permno == 78050 & time_avail_m >= tm(1998m1) & time_avail_m <= tm(2000m12), sep(0)
