* --------------
// DATA LOAD
use permno gvkey time_avail_m bh1m using "$pathDataIntermediate/SignalMasterTable", clear
...
merge 1:1 permno time_avail_m using "$pathDataIntermediate/monthlyShortInterest", keep(master match) nogenerate keepusing(shortint)
