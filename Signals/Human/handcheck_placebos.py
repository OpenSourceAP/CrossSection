...
stata_acc = pd.read_csv("../../Data/Placebos/Accruals.csv")
python_acc = pd.read_csv("../../pyData/Placebos/Accruals.csv")
stata_accbm = pd.read_csv("../../Data/Placebos/AccrualsBM.csv")
python_accbm = pd.read_csv("../../pyData/Placebos/AccrualsBM.csv")
