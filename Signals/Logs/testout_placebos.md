...
|---------------------------|-----------|--------------|-----------|-------------------------|
| GrGMToGrSales             | ✅ (0.00%)   | ✅ (0.00%)    | 0.0000    | ✅ (99th diff 2.3E-09)   |
| EarningsConservatism      | ❌ (2.52%)   | ✅ (3.56%)    | 0.0008    | ✅ (99th diff 6.4E-02)   |
| FailureProbabilityJune    | ❌ (0.00%)   | ✅ (0.21%)    | 0.1793    | ✅ (99th diff 1.7E-07)   |
| FailureProbability        | ❌ (0.00%)   | ✅ (0.11%)    | 0.1922    | ✅ (99th diff 6.1E-08)   |
| PS_q                      | ❌ (0.01%)   | ❌ (53.36%)   | 0.3707    | ❌ (99th diff 3.2E+00)   |
...
| roavol                    | ❌ (0.00%)   | ✅ (2.95%)    | 0.7738    | ✅ (99th diff 3.5E-02)   |
...
| EarningsTimeliness        | ❌ (2.52%)   | ✅ (0.00%)    | 1.0000    | ✅ (99th diff 4.8E-07)   |
...
**Overall**: 58/114 available placebos passed validation
...
```
 index  permno  yyyymm  AccrualQuality
     0   12319  198606        0.092578
     1   12319  198607        0.092578
     2   12319  198608        0.092578
     3   12319  198609        0.092578
     4   12319  198610        0.092578
     5   12319  198611        0.092578
     6   12319  198612        0.092578
     7   12319  198701        0.092578
     8   12319  198702        0.092578
     9   12319  198703        0.092578
```
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 160 Stata observations)
- Test 3 - Precision1 check: ❌ FAILED
- Test 4 - Precision2 check: ✅ PASSED
...
```
 index  permno  yyyymm  AssetLiquidityBookQuart
     ...
     5   12750  198212                 0.666923
     6   12750  198301                 0.695176
     7   12750  198302                 0.695176
     8   12750  198303                 0.943752
     9   12837  198004                 0.645111
```
...
```
 index  permno  yyyymm  AssetLiquidityMarketQuart
     ...
     5   12750  198212                   0.349204
     6   12750  198301                   0.398642
     7   12750  198302                   0.398642
     8   12750  198303                   0.541186
     9   12837  198004                   0.730060
```
...
```
 index  permno  yyyymm       BMq
     ...
     1   37233  197003 -0.385277
     2   37233  197004  0.053636
     3   37233  197005  0.294798
```
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 87 Stata observations)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ✅ PASSED
...
```
 index  permno  yyyymm    EBM_q
     ...
     3   10823  197303 1.051670
     4   10823  197304 1.045987
     5   10823  197305 1.051670
     6   11545  199706 0.477123
     7   11545  199707 0.421310
     8   11545  199708 0.383889
     9   12750  198212 0.099635
```
...
```
 index  permno  yyyymm      EPq
     ...
     3   11843  198803 0.040014
     4   11843  198804 0.081029
     5   11843  198805 0.055882
     6   12837  198004 0.033490
     7   12837  198005 0.028253
     8   15396  202409 0.248961
     9   15396  202410 0.275809
```
...
| 75%        |        -2.2170 |        -2.2137 |         0.0190 |       9.18e-10 |
...
- **Model**: python = 6993735351.3384 + -844643.9593 * stata
- **R-squared**: 0.0000
- **N observations**: 3,229,639

| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |     6.99e+09 |     2.02e+09 |      3.4636 |     0.001 |
| Slope       | -844643.9593 |     9.46e+06 |     -0.0892 |     0.929 |
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 253 Stata observations)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ✅ PASSED
...
```
 index  permno  yyyymm      KZ_q
     0   10547  200709 -4.571507
     1   10547  200710 -4.545523
     2   10547  200711 -4.575838
     3   10986  199008  8.309092
     4   10994  199204  5.937374
     5   10994  199205  6.358468
     6   11212  199008 -1.955831
     7   11545  199706 -1.346484
     8   11545  199707 -1.237483
     9   11545  199708 -1.146649
```
...
```
 index  permno  yyyymm  NetDebtPrice_q
     ...
     3   10823  197303        2.000325
     4   10823  197304        2.011255
     5   10823  197305        2.000325
...
```
 index  permno  yyyymm  OPLeverage_q
     ...
     3   12750  198212      0.294411
     4   12750  198301      0.294411
     5   12750  198302      0.294411
     6   12837  198004      0.584828
     7   12837  198005      0.584828
     8   15268  202412      0.375567
     9   16536  202003      0.434057
```
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 168 Stata observations)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ✅ PASSED
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 30 Stata observations)
- Test 3 - Precision1 check: ❌ FAILED
- Test 4 - Precision2 check: ❌ FAILED
...
**Precision1**: 53.361% obs with std_diff >= 1.00e-02 (tolerance: < 10%)
...
| Statistic  |          Stata |         Python |     Difference | Std Difference |
|------------|----------------|----------------|----------------|----------------|
| count      |    310620.0000 |    310620.0000 |    310620.0000 |    310620.0000 |
| mean       |         5.2218 |         4.7228 |        -0.4989 |        -0.3156 |
| std        |         1.5810 |         1.7963 |         1.5061 |         0.9526 |
...
- **Model**: python = 1.1106 + 0.6918 * stata
- **R-squared**: 0.3707
- **N observations**: 310,620

| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |       1.1106 |       0.0088 |    125.8753 |     0.000 |
| Slope       |       0.6918 |       0.0016 |    427.7397 |     0.000 |
...
**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 165750/310620 (53.361%)
...
```
   permno  yyyymm  python  stata  diff
0   77411  199403     1.0    8.0  -7.0
1   77411  199404     1.0    8.0  -7.0
2   77411  199405     1.0    8.0  -7.0
3   10005  198706     1.0    7.0  -6.0
4   10005  198707     1.0    7.0  -6.0
5   10005  198708     1.0    7.0  -6.0
6   10005  198709     1.0    7.0  -6.0
7   10005  198710     1.0    7.0  -6.0
8   10005  198711     1.0    7.0  -6.0
9   10005  198712     2.0    8.0  -6.0
```
...
```
 index  permno  yyyymm  RetNOA_q
     0   53022  198103  0.034347
     1   53022  198104  0.034347
     2   53022  198105  0.034347
```
...
```
 index  permno  yyyymm     SP_q
     ...
     6   16536  202003 3.127735
     7   16536  202004 3.086032
     8   16536  202005 2.457032
     9   19316  202412 0.195409
```
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 66 Stata observations)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ✅ PASSED
...
```
 index  permno  yyyymm      WW_Q
     ...
     1   10823  197303 -0.325508
     2   10823  197304 -0.284100
     3   10823  197305 -0.283327
...
**Precision1**: 2.947% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 3.47e-02 (tolerance: < 1.00e+00)
...
| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |     7.83e-04 |     5.91e-05 |     13.2545 |     0.000 |
| Slope       |       1.0027 |     3.80e-04 |   2641.6993 |     0.000 |
...
**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 60116/2039900 (2.947%)
...
```
 index  permno  yyyymm     sgr_q
     ...
     8   16536  202103 -0.277965
     9   16536  202104 -0.277965
```
