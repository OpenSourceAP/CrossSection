...
| MS                        | ✅         | ✅ (0.00%) | ✅ (+0.0%)   | ❌ (19.6%)    | ❌ (99.9th diff 2.6E+00) | ❌ (-0.76)  |
...
**Overall**: 91/212 available predictors passed validation
  - Natural passes: 86
  - Overridden passes: 5
...
**Precision1**: 19.575% obs with std_diff >= 1.00e-02 (tolerance: < 1%)
...
| mean       |         3.8814 |         3.8087 |        -0.0727 |        -0.0471 |
| std        |         1.5421 |         1.5240 |         0.5478 |         0.3552 |
...
- **Model**: python = 0.2175 + 0.9252 * stata
- **R-squared**: 0.8765
- **N observations**: 473,079

| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |       0.2175 |       0.0021 |    103.1460 |     0.000 |
| Slope       |       0.9252 |     5.05e-04 |   1832.4389 |     0.000 |

**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 92605/473079 (19.575%)
...
5   12209  202412       6      5     1
6   12411  202412       4      5    -1
7   13721  202412       5      6    -1
8   13956  202412       4      5    -1
9   14182  202412       2      1     1
```
