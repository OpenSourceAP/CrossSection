...
| CitationsRD               | ✅         | ❌ (1.59%) | ✅ (+2.3%)   | ❌ (2.5%)     | ❌ (2.4E+00)             | ✅ (+0.00)  |
...
| DivOmit                   | ✅         | ✅ (0.00%) | ✅ (+0.0%)   | ✅ (0.0%)     | ✅ (0.0E+00)             | ❌ (-0.37)  |
...
**Test Results**:
- Test 1 - Superset check: ❌ FAILED (Python missing 10248 Stata observations)
- Test 2 - NumRows check: ✅ PASSED (Python has +2.28% rows vs Stata)
- Test 3 - Precision1 check: ❌ FAILED
- Test 4 - Precision2 check: ❌ FAILED
- Test 5 - T-stat check: NA
...
**Precision1**: 2.473% obs with std_diff >= 1.00e-02 (tolerance: < 1%)

**Precision2**: 100th percentile diff = 2.44e+00 (tolerance: < 1.00e-01)

**Summary Statistics** (Common Observations):

| Statistic  |          Stata |         Python |     Difference | Std Difference |
|------------|----------------|----------------|----------------|----------------|
| count      |    635112.0000 |    635112.0000 |    635112.0000 |    635112.0000 |
| mean       |         0.2131 |         0.2378 |         0.0247 |         0.0604 |
| std        |         0.4095 |         0.4257 |         0.1553 |         0.3793 |
| min        |         0.0000 |         0.0000 |         0.0000 |         0.0000 |
| 25%        |         0.0000 |         0.0000 |         0.0000 |         0.0000 |
| 50%        |         0.0000 |         0.0000 |         0.0000 |         0.0000 |
| 75%        |         0.0000 |         0.0000 |         0.0000 |         0.0000 |
| max        |         1.0000 |         1.0000 |         1.0000 |         2.4421 |

**Regression Analysis** (Python ~ Stata):

- **Model**: python = 0.0314 + 0.9686 * stata
- **R-squared**: 0.8678
- **N observations**: 635,112

| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |       0.0314 |     2.19e-04 |    143.5577 |     0.000 |
| Slope       |       0.9686 |     4.74e-04 |   2042.1369 |     0.000 |

**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 15708/635112 (2.473%)
- Stata standard deviation: 4.09e-01

**Most Recent Bad Observations**:
```
   permno  yyyymm  python  stata  diff
0   11587  202505     1.0      0   1.0
1   15457  202505     1.0      0   1.0
2   18973  202505     1.0      0   1.0
3   27983  202505     1.0      0   1.0
4   35991  202505     1.0      0   1.0
5   36768  202505     1.0      0   1.0
6   36898  202505     1.0      0   1.0
7   43481  202505     1.0      0   1.0
8   44134  202505     1.0      0   1.0
9   48347  202505     1.0      0   1.0
```

**Largest Differences**:
```
   permno  yyyymm  python  stata  diff
0   10010  199506     1.0      0   1.0
1   10010  199507     1.0      0   1.0
2   10010  199508     1.0      0   1.0
3   10010  199509     1.0      0   1.0
4   10010  199510     1.0      0   1.0
5   10010  199511     1.0      0   1.0
6   10010  199512     1.0      0   1.0
7   10010  199601     1.0      0   1.0
8   10010  199602     1.0      0   1.0
9   10010  199603     1.0      0   1.0
```
