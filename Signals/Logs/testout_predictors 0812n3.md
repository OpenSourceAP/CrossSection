...
| MomOffSeason16YrPlus      | ✅         | ✅       | ✅           | ❌ (14.06%)   | ❌ (100th diff 1.2E-02)  |
...
| OptionVolume1             | ✅         | ✅       | ✅           | ✅ (0.04%)    | ✅ (100th diff 1.9E-04)  |
...
**Overall**: 130/181 available predictors passed validation
...
**Precision1**: 87.021% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 9.95e-02 (tolerance: < 1.00e-03)
...
**Precision1**: 91.884% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 6.16e-02 (tolerance: < 1.00e-03)
...
**Precision1**: 24.778% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 2.05e-02 (tolerance: < 1.00e-03)
...
**Precision1**: 24.779% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 2.42e-02 (tolerance: < 1.00e-03)
...
**Precision1**: 14.059% obs with std_diff >= 1.00e-02 (tolerance: < 10%)

**Precision2**: 99th percentile diff = 1.16e-02 (tolerance: < 1.00e-03)
