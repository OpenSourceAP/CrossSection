...
|---------------------------|------------|----------|-----------|--------------|-------------------------|
| PatentsRD                 | ✅         | ✅       | ❌ (96.72%)  | ❌ (36.06%)   | ❌ (100th diff 1.0E+00)  |
...
**Overall**: 20/173 available predictors passed validation
**Python CSVs**: 173/209 predictors have Python implementation
...
**Test Results**:
- Test 1 - Column names: ✅ PASSED
- Test 2 - Superset check: ❌ FAILED (Python missing 649782 Stata observations)
- Test 3 - Precision1 check: ❌ FAILED
- Test 4 - Precision2 check: ❌ FAILED
...
**Precision1**: 36.063% obs with std_diff >= 1.00e-02 (tolerance: < 0.1%)
...
**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 7952/22050 (36.063%)
- Stata standard deviation: 3.16e-01
...
2   18973  202412     1.0      0   1.0
3   20117  202412     1.0      0   1.0
4   20336  202412     1.0      0   1.0
5   25304  202412     1.0      0   1.0
6   28564  202412     1.0      0   1.0
7   32651  202412     1.0      0   1.0
8   33849  202412     1.0      0   1.0
9   41188  202412     1.0      0   1.0
```

**Largest Differences**:
```
   permno  yyyymm  python  stata  diff
0   10025  201606     1.0      0   1.0
1   10025  201607     1.0      0   1.0
2   10025  201608     1.0      0   1.0
3   10025  201609     1.0      0   1.0
4   10025  201610     1.0      0   1.0
5   10025  201611     1.0      0   1.0
6   10025  201612     1.0      0   1.0
7   10026  202406     1.0      0   1.0
8   10026  202407     1.0      0   1.0
9   10026  202408     1.0      0   1.0
```
